...
TENCENT_NEWS_DB_HOST = '127.0.0.1'
TENCENT_NEWS_DB_PORT = '3306'
TENCENT_NEWS_DB_USER = 'www-data'
TENCENT_NEWS_DB_PASSWORD = 'www->R&daD6xZM6283n3-data'
TENCENT_NEWS_DB_NAME = 'tencent_news_crawling'
