...
import re
import sqlalchemy
from flask import Flask, redirect, url_for, render_template, json, session, request, abort, make_response, g
...
#         return user_api_document('服务器内部错误，请刷新重试', 500)
#     except sqlalchemy.exc.DataError as e:
#         db_session.rollback()
#         return abort(make_response(str(e), 500))
#
...
#     except mysql.connector.errors.OperationalError as e:
#         app.logger.exception(e)
#         return event_api_document('服务器内部错误，请刷新重试', 500)
#     except sqlalchemy.exc.DataError as e:
#         db_session.rollback()
#         return abort(make_response(str(e), 500))
#     finally:
...
#     except mysql.connector.errors.OperationalError as e:
#         app.logger.exception(e)
#         return role_api_document('服务器内部错误，请刷新重试', 500)
#     except sqlalchemy.exc.DataError as e:
#         db_session.rollback()
#         return abort(make_response(str(e), 500))
#     finally:
...
#     except mysql.connector.errors.OperationalError as e:
#         app.logger.exception(e)
#         return service_template_api_document('服务器内部错误，请刷新重试', 500)
#     except sqlalchemy.exc.DataError as e:
#         db_session.rollback()
#         return abort(make_response(str(e), 500))
#     finally:
...
#     except mysql.connector.errors.OperationalError as e:
#         app.logger.exception(e)
#         return service_api_document('服务器内部错误，请刷新重试', 500)
#     except sqlalchemy.exc.DataError as e:
#         db_session.rollback()
#         return abort(make_response(str(e), 500))
#
...
# @app.route('/api/scholar-balance', methods=['GET', 'POST', 'PATCH', 'DELETE'])
...
#     except mysql.connector.errors.OperationalError as e:
#         app.logger.exception(e)
#         return scholar_balance_api_document('服务器内部错误，请刷新重试', 500)
#     except sqlalchemy.exc.DataError as e:
#         db_session.rollback()
#         return abort(make_response(str(e), 500))
#     finally:
...
#     except mysql.connector.errors.OperationalError as e:
#         app.logger.exception(e)
#         return service_password_api_document('服务器内部错误，请刷新重试', 500)
#     except sqlalchemy.exc.DataError as e:
#         db_session.rollback()
#         return abort(make_response(str(e), 500))
#     finally:
