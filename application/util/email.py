...
<body>
    <div style="font-size: 14px;">
        <p>亲爱的{}：</p>
        <p>您好，感谢注册Celery Soft学术，只差最后一步，就能完成注册，在48小时内点击下面的链接即可：</p>
        <p></p>
        <div><a href="{}">{}</a></div>
    ...
    <div style="font-size: 13px; margin-top: 48px;">
        <div>
            顺便，我们觉得有必要让您知道，如果您自己没有在Celery Soft学术进行注册的话，您收到这封邮件是因为有人在我们网站试图使用您的电子邮箱地址进行用户注册，如若没有您的同意，他是无法完成注册的，请您放心。
        </div>
        <div>
            如果您想在Celery Soft学术创建一个账号，请前往：
        </div>
        <div>
